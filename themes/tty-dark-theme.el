;;; tty-dark-theme.el -*- lexical-binding: t; -*-
...
;; This program is free software; you can coral1istribute it and/or modify
...
(custom-theme-set-faces
 ...
 '(diary-face ((t (:foreground "coral1"))))
 '(font-lock-builtin-face ((t (:foreground "#20b2aa"))))
 '(font-lock-comment-face ((t (:foreground "cyan"))))
 '(font-lock-constant-face ((t (:foreground "gold"))))
 '(font-lock-function-name-face ((t (:foreground "cyan"))))
 '(font-lock-keyword-face ((t (:foreground "coral1"))))
 '(font-lock-string-face ((t (:foreground "green"))))
 '(font-lock-type-face ((t (:foreground "yellow"))))
 '(font-lock-variable-name-face ((t (:foreground "#20b2aa"))))
 ...
 '(info-xref ((t (:bold t))))
 '(italic ((t (:underline t :background "coral1"))))
 '(message-cited-text-face ((t (:foreground "coral1"))))
 ...
 '(mode-line-buffer-id ((t (:background "white" :foreground "coral1"))))
 '(mode-line-mousable ((t (:background "white" :foreground "gold"))))
 ...
 '(show-paren-match-face ((t (:background "coral1"))))
 '(show-paren-mismatch-face ((t (:background "gold" :foreground "white"))))
